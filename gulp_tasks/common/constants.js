...
module.exports = function() {
    ...
    var constants = {
        ...
        repository: 'https://github.com/magnifito/famous-calendar',
        ...
        style: {
            ...
            css: {
                src: ['./bower_components/famous-angular/dist/famous-angular.css'] // you can also add a specific src_appname
            }
        },
        ...
        serve: {
            ...
            localtunnel: false // true, false or 'famous-calendar'
        },
        mocha: {
            libs: ['server/**/*.js'],
            tests: ['test/mocha/**/*.js'],
